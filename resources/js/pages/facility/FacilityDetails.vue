        ...
        <div class="card d-flex flex-row-fluid flex-center">
          ...
          >
            ...
            <div class="d-flex flex-stack pt-10">
              ...
              <div>
                <button v-if="currentPost ===4" @click="submitData()" type="button" class="btn btn-lg btn-primary me-3">
  ...
  if (step === 1) {
    ...
    const result = !(value.some(aisle => Object.values(aisle).some(i => !i)))
      ...
      all_units.forEach(aisle_units => {
          ...
          const status = !(aisle_units.unitsDetails.some(aisle => Object.values(aisle).some(i => !i)))
          if (status === false) {
              result = false;
          } else {
              result = true;
