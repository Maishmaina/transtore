  ...
  <div class="current">
    <div class="w-100">
      <div class="pb-10 pb-lg-15">
        ...
        <div class="text-muted fw-semibold fs-6">Please confirm Section, Aisle details and Submit</div>
      </div>
      <div class="fv-row">
          ...
          <span class="fs-3 fw-bold">Section Name :{{ confirm_all.section }}</span>
        </label>
         <div class="pe-md-10 mb-10 mb-md-0">
          <div class="m-0" v-for="(aisle,i) in confirm_all.aisle" :key="i">
            <div
...
const { setOne, aisleListing } = useFacilityStore();

const confirm_all = ref({
